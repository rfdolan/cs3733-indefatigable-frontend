...
class VideoPanel extends React.Component {
    ...
    character={currVid.character} isRemote={currVid.isRemote} isRemotelyAvailable={currVid.isRemotelyAvailable} id={currVid.vuid} deleteVideoHandler={this.getAllVideos} inPlaylistView={false}/></li>);
            }
        }
